...
class _ForecastApiService implements ForecastApiService {
  ...
  Future<TennisPlayPredictionResponse> tennisPlayPrediction(
    ...
    _data.addAll(features.toJson());
    final _options = _setStreamType<TennisPlayPredictionResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TennisPlayPredictionResponse _value;
    try {
      _value = TennisPlayPredictionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
